              ...
              mbedtls_pk_context *pk_key)
{
  ...
  //HAL_Delay(20000);
  size_t nb_writen;
  ret = mbedtls_pk_sign(pk_key, MBEDTLS_MD_SHA256, hash, 32, hash_signed,
                        &nb_writen, mbedtls_hmac_drbg_random, &rng_ctx);
  /*mbedtls_rsa_context* ctx = mbedtls_pk_rsa(*pk_key);
  ret = mbedtls_rsa_pkcs1_sign(ctx, mbedtls_hmac_drbg_random, &rng_ctx,
